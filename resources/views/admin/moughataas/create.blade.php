...
@section('content')
    <h2 class="text-2xl font-semibold mb-4">Create Moughataa</h2>
    <form action="{{ route('admin.moughataas.store') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        @csrf
        <div class="mb-4">
