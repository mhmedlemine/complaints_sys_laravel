...
@section('content')
    <h2 class="text-2xl font-semibold mb-4">Create Consumer</h2>
    <form action="{{ route('admin.consumers.store') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
            <label class="block text-gray-700 text-sm font-bold mb-2" for="lnamer">
                Last Name
            </label>
        ...
        <div class="mb-4">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="address" type="text" step="any" name="address" required>
        </div>
